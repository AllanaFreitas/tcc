function Funcionamento() {
  return (
    <div>
        ...
        <section>
            <h1 className='font-kulim'>Funcionamento</h1>
            ...
            <p className="font-kulim">1 - Conecte os sensores na sua janela.</p>
            <p className="font-kulim">2 - Conecte ao Arduino e programe.</p>
            <p className="font-kulim">3 - Execute o programa da janela.</p>
